...
3 - zip dosyası içindeki csv dosyalarının tüm içeriğini tek bir csv dosyasında birleştir volume olmayacak
4 - bu kayıtların tamamını sqlite veritabanına bir tablo oluşturarak yükle
5 - kullanıcının belirlediği paritenin kullanıcının belirlediği aralığının
    kullanıcının belirlediği değerin grafiğini çizdir (veriler sqlite tan çekilecek)
"""
import os
import zipfile
import pandas as pd
